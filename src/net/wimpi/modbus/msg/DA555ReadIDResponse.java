 ...
 */
public final class DA555ReadIDResponse extends ModbusResponse {
	 ...
	 */
	public DA555ReadIDResponse(InputRegister[] registers) {
		super();
		setFunctionCode(Modbus.DA555_READ_ID);
	...
	public String toString() {
		return "DA555ReadIDResponse - Words: " + getWordCount();
	}
