...
public class SerialPort {
    ...
    public Method getMethodErrorOccurred() {
		return methodErrorOccurred;
	}

	public void setMethodErrorOccurred(Method methodErrorOccurred) {
		this.methodErrorOccurred = methodErrorOccurred;
	}
